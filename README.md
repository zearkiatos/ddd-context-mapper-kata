# Description
This a project to understand how to work with a context mapper in order to apply this tool 🛠️ in a domain driven development (DDD) in order to build a no monolith solution 👨🏻‍💻
